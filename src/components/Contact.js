...
const Contact = () => {
  return (
    <div className='contact'>
      <a href='https://twitter.com/jsxike' rel='noreferrer' target='_blank' className='contact_twitter'>
        <FaTwitter className='contact_icon' />
      </a>
      <a href='https://github.com/jsxike' rel='noreferrer' target='_blank' className='contact_github'>
